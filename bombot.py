import discord # made by ⍭ Relaxxs#2467
import asyncio
...
TOKEN = "MTA4OTI1NDAyOTU1NDYzMDY5Ng.GWXl0h.1IIBYU3d0EtBIQXhzK0MVTfqfz1-qD3A4winFk"
gif = "https://share.creavite.co/QRgoimvmzZmAKGzG.gif"  # embede ekleyeceğiniz gif linki (https://auto.creavite.co bu sitede kıyağım olsun gidip parayla yaptırmayın)
...
async def on_ready():
    ...
    activity = discord.Activity(type=discord.ActivityType.listening, name="Made By ⍭ Relaxxs#2467") # Botun oynuyor kısmıdır
...
async def on_message(message):
    ...
    if message.content.startswith("!spam "):
        ...
        if len(telno) == 10:
            ...
            embed.set_footer(text="Made by ⍭ Relaxxs#2467 - ©2023") # footer
            ...
            embed = discord.Embed(
                title="Lates Sms platformu!",
                description="Başarılı şekilde işlemin tamamlandı. *Bizi tercih ettiğin için teşekkürler.*"
            )
            embed.set_footer(text="Bu mesaj 30 saniye sonra otomatik olarak silinecektir. | Made By ⍭ Relaxxs#2467") ## KOMUTU KULLANANA ÖZELDEN MESAJ AT VE 30 SANİYE SONRA SİL
      ...
      ###  Yardım menüsü
        ...
        embed.add_field(name="`!spam [telefon numarası]`", value="Belirtilen telefon numarasına bir SMS gönderir.", inline=False)
